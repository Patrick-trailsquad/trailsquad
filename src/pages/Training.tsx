...
Så vil vores trail træningssessions være noget for dig!</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 mt-12 px-2 md:px-0">
              {/* Session 2 (inactive - past event) */}
              <div className="bg-stone rounded-lg overflow-hidden shadow-lg flex flex-col opacity-60 relative">
                <div className="absolute top-4 right-4 z-20 bg-charcoal text-white px-3 py-1 rounded-full text-sm font-cabinet font-medium">
                  Afsluttet
                </div>
                ...
                <div className="p-6 flex flex-col flex-grow">
                  ...
                  <button disabled className="w-full bg-gray-400 text-white px-8 py-4 rounded-full font-cabinet font-medium cursor-not-allowed border-2 border-gray-500">
                    Afsluttet
                  </button>
                </div>
              </div>
