...
const trainingSessions: TrainingSession[] = [
  {
    ...
    meetingTime: "18:00",
    endTime: "19:00",
    location: "Copenhill, København S",
    meetingPlace: "Vindmøllevej 6, 2300 København S",
    description:
      "Vi mødes på Copenhill og træner stigninger på byens sjoveste bakke. Perfekt til at bygge styrke i benene inden sæsonens ture.",
  ...
  },
  {
    ...
    description:
      "Tema: Bakkeintervaller ⛰️\n\nVi arbejder med power, rytme og kontrol på stigningerne.",
