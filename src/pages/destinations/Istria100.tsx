...
import IstriaIncludedAmenities from "../../components/destinations/istria/IstriaIncludedAmenities";
import IstriaHero from "../../components/destinations/istria/IstriaHero";
import IstriaInfoBanner from "../../components/destinations/istria/IstriaInfoBanner";
import IstriaDescription from "../../components/destinations/istria/IstriaDescription";
import IstriaMediaSection from "../../components/destinations/istria/IstriaMediaSection";
import IstriaAccommodation from "../../components/destinations/istria/IstriaAccommodation";
import { useIsMobile } from "../../hooks/use-mobile";
import TrailSquadSection from "../../components/destinations/shared/TrailSquadSection";

const Istria100 = () => {
  useScrollToTop();
  usePageTitle('Istria 100 by UTMB');
  ...
  return (
    <div className="min-h-screen bg-stone">
      ...
      <div className="mt-12 mb-20">
        <IstriaIncludedAmenities className="bg-transparent" />
      </div>
