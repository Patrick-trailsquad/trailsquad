        ...
        <div className="grid grid-cols-2 gap-6 mb-6">
          <div className="col-span-2 space-y-1">
            ...
            <p className="font-cabinet text-4xl font-bold text-charcoal">
              8.600 DKK <span className="text-sm text-gray-500">inkl. moms</span>
            </p>
            <Accordion type="single" collapsible className="w-full mt-2">
              <AccordionItem value="price-details" className="border-none">
                ...
                <AccordionContent className="px-0 pt-2 text-gray-700 text-sm">
                  <div>
                    Prisen for et <b>Delt Olive Garden View Room</b> er 8.600 DKK per person, og du vil dele værelset med en fra din egen gruppe. Det betyder, at du ikke kan booke et delt værelse, hvis du tilmelder dig alene.<br /><br />
