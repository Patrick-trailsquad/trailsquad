...
interface IstriaIncludedAmenitiesProps {
  className?: string;
}

const IstriaIncludedAmenities = ({ className = "" }: IstriaIncludedAmenitiesProps) => {
  const amenities = [
    {
    ...
    },
    {
      ...
      description: "Morgenmad og frokost inkluderet"
    },
    {
...
export default IstriaIncludedAmenities;