    ...
    <div className="space-y-6 mb-8">
      <div className="bg-yellow-400 border-2 border-black rounded-xl p-4 mb-6">
        ...
        <p className="text-black text-sm">
          Planlægningen og eksekveringen af Flash-ture er lidt mere rock'n'roll. Vi køber ikke et større antal løbsbilletter i forvejen, og lukker hurtigere ned for destinationen ift de andre Trail Squad ture. Så du skal være vaks! <br /><a href="https://www.trailsquad.dk/flash" className="underline hover:text-terra transition-colors">Læs mere om Flash-ture her</a>.
        </p>
      </div>
