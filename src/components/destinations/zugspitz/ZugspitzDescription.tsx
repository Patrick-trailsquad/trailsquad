  ...
  return (
    <div className="space-y-6 mb-8">
      ...
      <div>
        ...
        <p className="text-lg">
          Da løbene afholdes over flere dage, vil det være muligt at deltage på 5 forskellige distancer. De helt lange starter fredag aften (86 km og 106 km) og lørdagens løb spænder over henholdsvis 16 km, 44 km, og 68 km. Så der er bestemt noget for enhver smag. Hver rute lover unikke udfordringer og uforglemmelige alpine landskaber.
        </p>
      </div>
