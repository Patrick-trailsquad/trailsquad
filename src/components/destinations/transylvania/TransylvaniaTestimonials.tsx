  ...
  const fetchTestimonials = async () => {
    try {
      const { data, error } = await supabase
        .from('testimonials')
        .select('*')
        .eq('destination', 'Transylvania 100')
  ...
  return (
    <section className="py-16 bg-white">
          ...
          <>
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-charcoal/70 max-w-2xl mx-auto">
                Hør hvad vores tidligere deltagere siger om deres Transylvania 100 oplevelse
              </p>
            </div>
          ...
          <div className="max-w-2xl mx-auto text-center py-16">
            <div className="mb-8">
              ...
              <p className="text-lg text-charcoal/70 mb-8">
                Har du deltaget i Transylvania 100? Del din oplevelse og hjælp andre løbere med at forberede sig til eventyret.
              </p>
            </div>
      ...
      <AddTestimonialModal
        ...
        destination="Transylvania 100"
        distances={["20km", "30km", "50km", "80km", "100km"]}
      />
    </section>
  );
};

export default TransylvaniaTestimonials;
