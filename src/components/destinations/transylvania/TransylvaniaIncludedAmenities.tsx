...
interface TransylvaniaIncludedAmenitiesProps {
  className?: string;
}

const TransylvaniaIncludedAmenities = ({ className = "" }: TransylvaniaIncludedAmenitiesProps) => {
  const amenities = [
    {
    ...
    },
    {
      ...
      title: "5-Stjernet Hotel",
      description: "5-stjernet luksus hotelindkvartering"
    },
    {
...
export default TransylvaniaIncludedAmenities;
