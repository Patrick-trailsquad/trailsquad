...
const InfiniteTrailsTestimonials = () => {
  ...
  const fetchTestimonials = async () => {
    try {
      const { data, error } = await supabase
        .from('testimonials')
        .select('*')
        .eq('destination', 'Infinite Trails')
  ...
  const allTestimonials = dbTestimonials.map(t => {
    ...
    return {
      ...
      review: t.review,
      race: t.distance,
      photos: photos.length > 0 ? photos : ["/lovable-uploads/infinite-trails.jpg"],
          ...
          <>
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-charcoal/70 max-w-2xl mx-auto">
                Hør hvad vores tidligere deltagere siger om deres Infinite Trails oplevelse
              </p>
            </div>
          ...
          <div className="max-w-2xl mx-auto text-center py-16">
            <div className="mb-8">
              ...
              <p className="text-lg text-charcoal/70 mb-8">
                Har du deltaget i Infinite Trails? Del din oplevelse og hjælp andre løbere med at forberede sig til eventyret.
              </p>
            </div>
...
export default InfiniteTrailsTestimonials;
