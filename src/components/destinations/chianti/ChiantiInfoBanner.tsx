      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
          <div>
            ...
            <h2 className="font-cabinet text-lg text-charcoal">Chianti Region, Tuscany, Italy</h2>
          </div>
          <div>
            <h1 className="font-cabinet text-2xl font-bold text-charcoal">Race Day</h1>
            <h2 className="font-cabinet text-lg text-charcoal">March (TBD), 2026</h2>
          </div>
          <div>
          ...
          <div>
            ...
            <h2 className="font-cabinet text-lg text-charcoal">20km, 46km, 73km, 120km</h2>
          </div>
        </div>
      </div>
    </div>
...
export default ChiantiInfoBanner;
