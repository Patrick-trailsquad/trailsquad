        ...
        <div className="bg-white rounded-xl overflow-hidden shadow-lg">
          ...
          <div className="p-6">
            ...
            <div className="bg-stone rounded-lg p-4 mb-4">
              ...
              <p className="text-xs font-cabinet font-semibold text-terra mt-2">3 værelser tilbage</p>
            </div>
            <div className="bg-stone rounded-lg p-4 mb-4">
        ...
        <div className="bg-white rounded-xl overflow-hidden shadow-lg">
          ...
          <div className="p-6">
            ...
            <div className="bg-stone rounded-lg p-4 mb-4">
              ...
              <p className="text-xs font-cabinet font-semibold text-terra mt-2">6 værelser tilbage</p>
            </div>
          </div>
        </div>
      </div>
