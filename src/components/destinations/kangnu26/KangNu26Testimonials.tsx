...
const KangNu26Testimonials = () => {
  ...
  const fetchTestimonials = async () => {
    try {
      const { data, error } = await supabase
        .from('testimonials')
        .select('*')
        .eq('destination', 'KangNu Running Race')
  ...
  const allTestimonials = dbTestimonials.map(t => {
    ...
    return {
      ...
      review: t.review,
      race: t.distance,
      photos: photos.length > 0 ? photos : ["/lovable-uploads/kangnu26-hero.jpg"],
  ...
  return (
    <section className="py-16 bg-white">
          ...
          <>
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-charcoal/70 max-w-2xl mx-auto">
                Hør hvad vores tidligere deltagere siger om deres KangNu Running Race oplevelse
              </p>
            </div>
          ...
          <div className="max-w-2xl mx-auto text-center py-16">
            <div className="mb-8">
              ...
              <p className="text-lg text-charcoal/70 mb-8">
                Har du deltaget i KangNu Running Race? Del din oplevelse og hjælp andre løbere med at forberede sig til eventyret.
              </p>
            </div>
      ...
      <AddTestimonialModal
        ...
        distances={["15km", "32km", "51km"]}
      />
    </section>
  );
};

export default KangNu26Testimonials;
