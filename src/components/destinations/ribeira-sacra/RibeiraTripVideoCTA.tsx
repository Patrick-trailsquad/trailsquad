...
const RibeiraTripVideoCTA = () => {
  ...
  const videoUrl = "https://www.youtube.com/embed/aP96sAb9B1g?autoplay=1";
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-6">
          <h2 className="font-cabinet text-3xl md:text-4xl font-bold text-charcoal mb-2">
            Se video fra turen i oktober 2025!    
          </h2>
        ...
        <div className="relative w-full rounded-xl overflow-hidden shadow-lg">
          {!isPlaying ? <button onClick={() => setIsPlaying(true)} className="relative w-full group cursor-pointer">
              <img src={thumbnailUrl} alt="Trail Ribeira Sacra video thumbnail" className="w-full aspect-video object-cover" />
              ...
              <iframe src={videoUrl} title="Trail Ribeira Sacra video" className="w-full h-full" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
            </div>}
        </div>
      </div>
    </div>;
