...
const LaBoucleDeLEtoileAccommodation = () => {
  ...
  const images = ["/lovable-uploads/la-boucle-bivouac.jpg"];
  return <div className="container mx-auto px-4 py-16 bg-stone rounded-xl mb-12">
        ...
        <div className={isMobile ? "order-2" : ""}>
          ...
          <div className="space-y-2 text-lg">
            ...
            <ul className="list-disc list-inside ml-4 space-y-1">
              ...
              <li>Komfortable madrasser med sovepose inkluderet    </li>
            </ul>
            ...
            <CarouselContent>
              {images.map((image, index) => <CarouselItem key={index}>
                  <div className="relative aspect-[4/3] w-full">
                    <img src={image} alt={`The Comodo ${index + 1}`} className="w-full h-full object-cover rounded-xl" />
                  </div>
                </CarouselItem>)}
            </CarouselContent>
            {images.length > 1 && (
