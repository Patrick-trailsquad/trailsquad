  ...
  return <div className="bg-white rounded-xl p-8 shadow-lg">
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="font-cabinet text-4xl font-bold text-charcoal">17.500 DKK</p>
...
Prisen for et solo telt vil formentlig være nogle tusind kr dyrere - dette er endnu ikke afklaret.
