    ...
    <div>
      <div className="space-y-6 mb-8">
        <div>
          ...
          <p className="text-lg">
            La Boucle de l'Étoile kombinerer det bedste fra alpin trailløb med den unikke charme af Bad Gastein i østrigske alper. 
        ...
        <div>
          ...
          <p className="text-lg">
            ...
            højde. Den kompakte løbsweekend og de forskellige distancer gør La Boucle de l'Étoile perfekt for både erfarne 
