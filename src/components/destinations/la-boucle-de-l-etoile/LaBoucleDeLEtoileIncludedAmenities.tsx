...
interface LaBoucleDeLEtoileIncludedAmenitiesProps {
  className?: string;
}

const LaBoucleDeLEtoileIncludedAmenities = ({ className }: LaBoucleDeLEtoileIncludedAmenitiesProps) => {
...
export default LaBoucleDeLEtoileIncludedAmenities;
