      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
          ...
          <div>
            ...
            <h2 className="font-cabinet text-lg text-charcoal">8. august 2026</h2>
          </div>
          <div>
            <h1 className="font-cabinet text-2xl font-bold text-charcoal">Turens varighed</h1>
            <h2 className="font-cabinet text-lg text-charcoal">6.-9. august 2026 (4 dage)</h2>
          </div>
          <div>
...
export default SwissAlps100InfoBanner;