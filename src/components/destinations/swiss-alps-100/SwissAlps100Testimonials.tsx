...
const SwissAlps100Testimonials = () => {
    ...
    return (
      <div className="mb-4">
        <div
          ...
          style={{ lineHeight: '1.5rem', maxHeight: isExpanded ? fullHeight : '216px' }}
        >
          "{text}"
        </div>
        {needsExpansion && (
        ...
        {[1, 2, 3, 4, 5].map((star) => (
          <Star
            ...
            className={`w-16 h-16 transition-all duration-300 ${
              star <= currentRating ? "fill-[#FFDC00] text-[#FFDC00]" : "text-gray-300"
            }`}
          />
        ))}
      </div>
  ...
  const allTestimonials = dbTestimonials.map(t => {
    ...
    return {
      ...
      review: t.review,
      race: t.distance,
      photos: photos.length > 0 ? photos : ["/lovable-uploads/swiss-alps-100-hero-new.jpg"],
  ...
  return (
    <section className="py-16 bg-white">
          ...
          <>
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-charcoal/70 max-w-2xl mx-auto">
                Hør hvad vores tidligere deltagere siger om deres Swiss Alps 100 oplevelse
              </p>
            </div>
          ...
          <div className="max-w-2xl mx-auto text-center py-16">
            <div className="mb-8">
              ...
              <p className="text-lg text-charcoal/70 mb-8">
                Har du deltaget i Swiss Alps 100? Del din oplevelse og hjælp andre løbere med at forberede sig til eventyret.
              </p>
            </div>

            <button
              onClick={() => setIsModalOpen(true)}
              className="bg-[#FFDC00] hover:bg-[#FFDC00]/90 text-charcoal px-12 py-6 rounded-full font-cabinet font-bold text-xl transition-colors shadow-lg hover:shadow-xl transform hover:scale-105"
            >
      ...
      <AddTestimonialModal
        ...
        destination="Swiss Alps 100"
        distances={["50km", "100km", "160km"]}
      />
    </section>
  );
};

export default SwissAlps100Testimonials;
