...
>(({ className, value, step, totalSteps, ...props }, ref) => (
  <div className="w-full flex justify-center"> {/* Center the progress container */}
    <div className="w-[95%] flex items-center space-x-2"> {/* Reduced width to prevent line break */}
