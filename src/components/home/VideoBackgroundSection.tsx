    ...
    <section ref={sectionRef} className="relative w-full h-[80vh] md:h-[85vh] overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-center h-full px-8">
        <div className="text-center text-white">
          ...
          <h2 className="text-xl md:text-2xl font-inter font-light mb-8 max-w-2xl mx-auto">Løbeteknik, udstyr, energi på løbsdagen... Vi har din ryg i forberedelserne op til race day. 

Der er månedlig fællestræning og det er gratis at deltage. 
Vi plejer at løbe i Dyrehaven, Frederiksberg Have, ved Furesøen eller lignende.<br />
