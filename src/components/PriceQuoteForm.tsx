                ...
                <div>
                  ...
                  <div className="mt-4">
                    <p className="text-sm text-gray-700 font-medium">
                      After submitting your request you will receive an email with the specific quote,
                      along with a Stripe link to pay 75% of the price to confirm.
                      We will revert back 60 days before departure to collect the remaining 25% of the price.
                    </p>
                  </div>
                </div>
              </div>
