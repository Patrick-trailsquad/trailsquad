        ...
        <div className="mt-6 pb-6">
          {isSubmitted ? <div className="bg-green-50 rounded-lg p-4 flex items-start gap-3">
              ...
              <div className="bg-stone/50 rounded-lg p-4 flex items-start gap-3 mb-6">
                ...
                <div>
                  <p className="text-sm text-gray-600 mb-2">Udfyld denne formular, betalt depositum på DKK 10.000, og vi vender tilbage til dig med en personligt opfølgning inden for 48 timer på hverdage.</p>
