      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-600 mb-8">
            The Trail Squad project is born from a passion for trail and ultra running, coupled with the awesomeness of going sports adventures in exciting locations. We have been running many races across the continent, and though the pain is real when you hit the wall on the long runs, the post-race celebratory drinks taste heavenly and make it all worthwhile.<br /><br />
