              ...
              <Sheet>
                ...
                <SheetContent side="right" className="w-full bg-black/95 p-0 !border-0">
                  <div className="flex flex-col items-center justify-center min-h-screen relative -translate-y-5">
                    ...
                    >
                      <path
                        d="M0 200 C50 180 150 100 300 80 C350 70 380 120 400 100 C500 140 550 160 600 180 C700 120 800 80 900 60 C1000 100 1050 120 1100 140 C1150 120 1180 110 1200 100 L1200 200 L0 200 Z"
                        fill="none"
                        stroke="#FFDC00"
                        strokeWidth="3"
                        strokeLinecap="round"
